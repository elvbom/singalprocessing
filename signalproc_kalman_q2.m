...
ylabel('Position')
title('Method 2: position and velocity estimates')
...
title('Method 2: traces error covariance matrix')
xlabel('Time')
...
title('Comparison error covariance matrices for method 1 and method 2')
